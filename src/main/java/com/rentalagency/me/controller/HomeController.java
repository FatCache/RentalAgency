...
public class HomeController {
	...
	public String loginUser(Model model, @RequestParam(value = "email", required = false) String email,
	...
	public String createAccount(Model model, @RequestParam(value = "username") String username,
	...
	public String changePasswordGet(Model model) {
		model.addAttribute("pagetype", "passwordchange");
